# Pi Pico-i2c-reader-writer-with-terminal-user-interface
...
### The user inteface is by a terminal such as ExtraPutty or Terraterm. The Pi Pico displays a menu with commands to operate the functions which include:
